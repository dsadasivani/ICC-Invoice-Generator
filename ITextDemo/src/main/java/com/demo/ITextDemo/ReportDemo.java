...
public class ReportDemo {
	...
	public void createPdf(String dest) throws IOException, FileNotFoundException, MalformedURLException {
        ...
        addOrderDetails(document, Arrays.asList(
        		new OrderPOJO("Agent", "404547", getFormattedDate(), "ARC", "At Company Warehouse", "CREDIT", "30 Days")
        		));
        document.add(new Paragraph("Invoice Details:").setBold().setFontSize(7f));
        addInvoiceDetails(document, Arrays.asList(
//        		new InvoicePOJO("192773", "LEAKSEAL CEMENT WATER PROOFING LIQUID\n(1 Ltr x 20 Btls)", 20, 2600)
        		new InvoicePOJO("192774", "LEAKSEAL CEMENT WATER PROOFING LIQUID\n(5 Ltr x 4 Jars)", 10, 2550)
...
//        		new InvoicePOJO("192777", "AQUA TIGHT CEMENT WATER PROOFING LIQUID\n(5 Ltrs x 4 Jars)", 18, 2200)
        		));
...
//		consigneeTable.addCell(innerConTable);
	...
	private void setAddressAndInvoiceDetails(Document document) {
	    ...
	    invoiceTable.addCell("16");
	    invoiceTable.addCell("DATE");
	    invoiceTable.addCell("06/07/2020");
        //Add invisible table
	...
	public void addHeaderImage(Document layoutDocument) throws MalformedURLException {
		Image image = new Image(ImageDataFactory.create("resources/HeaderImage.png")).setWidth(518f);
